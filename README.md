...
This project was created with [native-hero-template](https://github.com/AmanVarshney01/create-native-hero-template), a modern TypeScript monorepo that combines React, Expo (React Native), TanStack Query, ORPC, Hono, Mongoose/MongoDB, and Better-Auth for authentication.
